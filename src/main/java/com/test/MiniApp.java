...
public class MiniApp {
    ...
    private void initializeApplication() {
        // BLOCKER: Reading from hardcoded absolute path -> Now using AWS SSM Parameter Store
        loadConfiguration();
    ...
    private void loadConfiguration() {
        try {
            // Using AWS Systems Manager Parameter Store instead of classpath or S3 properties file
            ...
            System.out.println("Configuration loaded from AWS SSM Parameter Store: /mini-java-app/config");
        } catch (IOException e) {
            System.err.println("Failed to load configuration from AWS SSM: " + e.getMessage());
        } catch (Exception e) {
            System.err.println("An error occurred while loading configuration from AWS SSM: " + e.getMessage());
        }
    }
    ...
    private void initializeLogging() {
        ...
        try {
            ...
            System.out.println("Logging initialized in S3 at: " + LOG_S3_BUCKET + "/" + LOG_S3_KEY);
        } catch (Exception e) {
